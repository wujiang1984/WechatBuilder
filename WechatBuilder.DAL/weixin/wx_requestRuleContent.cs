...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_requestRuleContent
	{
		...
		public WechatBuilder.Model.wx_requestRuleContent GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_requestRuleContent model=new WechatBuilder.Model.wx_requestRuleContent();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_requestRuleContent DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_requestRuleContent model=new WechatBuilder.Model.wx_requestRuleContent();
			if (row != null)
			{
        ...
        {
            IList<WechatBuilder.Model.wx_requestRuleContent> rcList = new List<Model.wx_requestRuleContent>();
            ...
            while (sr.Read())
            {
                model = new WechatBuilder.Model.wx_requestRuleContent();
                model.rContent = sr["rContent"].ToString();
                model.rContent2 = sr["rContent2"].ToString();
