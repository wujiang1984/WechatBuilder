...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_dzpAwardItem
	{
		...
		public WechatBuilder.Model.wx_dzpAwardItem GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_dzpAwardItem model=new WechatBuilder.Model.wx_dzpAwardItem();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_dzpAwardItem DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_dzpAwardItem model=new WechatBuilder.Model.wx_dzpAwardItem();
			if (row != null)
			{
