...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_dzpUsersTemp
	{
		...
		public WechatBuilder.Model.wx_dzpUsersTemp GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_dzpUsersTemp model=new WechatBuilder.Model.wx_dzpUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_dzpUsersTemp DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_dzpUsersTemp model=new WechatBuilder.Model.wx_dzpUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public WechatBuilder.Model.wx_dzpUsersTemp getModelByAidOpenid(int actId, string openid)
        {
