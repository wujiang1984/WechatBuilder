...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_dzpActionInfo
	{
		...
		public WechatBuilder.Model.wx_dzpActionInfo GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_dzpActionInfo model=new WechatBuilder.Model.wx_dzpActionInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_dzpActionInfo DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_dzpActionInfo model=new WechatBuilder.Model.wx_dzpActionInfo();
			if (row != null)
			{
