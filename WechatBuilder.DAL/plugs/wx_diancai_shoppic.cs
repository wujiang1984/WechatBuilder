...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_diancai_shoppic
	{
		...
		public WechatBuilder.Model.wx_diancai_shoppic GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_diancai_shoppic model=new WechatBuilder.Model.wx_diancai_shoppic();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_diancai_shoppic DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_diancai_shoppic model=new WechatBuilder.Model.wx_diancai_shoppic();
			if (row != null)
			{
