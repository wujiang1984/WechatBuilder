...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_dzpAwardUser
	{
		...
		public WechatBuilder.Model.wx_dzpAwardUser GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_dzpAwardUser model=new WechatBuilder.Model.wx_dzpAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_dzpAwardUser DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_dzpAwardUser model=new WechatBuilder.Model.wx_dzpAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public WechatBuilder.Model.wx_dzpAwardUser getZJinfoByOpenid(int actId, string openid)
        {
