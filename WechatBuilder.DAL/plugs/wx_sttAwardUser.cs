...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_sttAwardUser
	{
		...
		public WechatBuilder.Model.wx_sttAwardUser GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_sttAwardUser model=new WechatBuilder.Model.wx_sttAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_sttAwardUser DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_sttAwardUser model=new WechatBuilder.Model.wx_sttAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public WechatBuilder.Model.wx_sttAwardUser getZJinfoByOpenid(int actId, string openid)
        {
