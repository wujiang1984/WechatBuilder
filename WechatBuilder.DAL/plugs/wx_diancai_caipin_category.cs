...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_diancai_caipin_category
	{
		...
		public WechatBuilder.Model.wx_diancai_caipin_category GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_diancai_caipin_category model=new WechatBuilder.Model.wx_diancai_caipin_category();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_diancai_caipin_category DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_diancai_caipin_category model=new WechatBuilder.Model.wx_diancai_caipin_category();
			if (row != null)
			{
