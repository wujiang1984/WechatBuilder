...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_ggkActionInfo
	{
		...
		public WechatBuilder.Model.wx_ggkActionInfo GetModel(int id)
		{
            ...
            WechatBuilder.Model.wx_ggkActionInfo model = new WechatBuilder.Model.wx_ggkActionInfo();
		...
		/// 得到一个对象实体
		/// </summary>
        public WechatBuilder.Model.wx_ggkActionInfo DataRowToModel(DataRow row)
        {
            WechatBuilder.Model.wx_ggkActionInfo model = new WechatBuilder.Model.wx_ggkActionInfo();
            if (row != null)
            {
