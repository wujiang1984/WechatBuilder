...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_ggkAwardItem
	{
		...
		public WechatBuilder.Model.wx_ggkAwardItem GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_ggkAwardItem model=new WechatBuilder.Model.wx_ggkAwardItem();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_ggkAwardItem DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_ggkAwardItem model=new WechatBuilder.Model.wx_ggkAwardItem();
			if (row != null)
			{
