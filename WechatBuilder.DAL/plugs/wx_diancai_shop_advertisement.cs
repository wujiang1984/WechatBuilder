...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_diancai_shop_advertisement
	{
		...
		public WechatBuilder.Model.wx_diancai_shop_advertisement GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_diancai_shop_advertisement model=new WechatBuilder.Model.wx_diancai_shop_advertisement();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_diancai_shop_advertisement DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_diancai_shop_advertisement model=new WechatBuilder.Model.wx_diancai_shop_advertisement();
			if (row != null)
			{
