...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_ggkUsersTemp
	{
		...
		public WechatBuilder.Model.wx_ggkUsersTemp GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_ggkUsersTemp model=new WechatBuilder.Model.wx_ggkUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_ggkUsersTemp DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_ggkUsersTemp model=new WechatBuilder.Model.wx_ggkUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public WechatBuilder.Model.wx_ggkUsersTemp getModelByAidOpenid(int actId, string openid)
        {
