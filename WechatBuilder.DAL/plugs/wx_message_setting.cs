...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_message_setting
	{
		...
		public WechatBuilder.Model.wx_message_setting GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_message_setting model=new WechatBuilder.Model.wx_message_setting();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_message_setting DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_message_setting model=new WechatBuilder.Model.wx_message_setting();
			if (row != null)
			{
