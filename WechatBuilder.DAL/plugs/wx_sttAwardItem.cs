...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_sttAwardItem
	{
		...
		public WechatBuilder.Model.wx_sttAwardItem GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_sttAwardItem model=new WechatBuilder.Model.wx_sttAwardItem();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_sttAwardItem DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_sttAwardItem model=new WechatBuilder.Model.wx_sttAwardItem();
			if (row != null)
			{
