...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_ggkAwardUser
	{
		...
		public WechatBuilder.Model.wx_ggkAwardUser GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_ggkAwardUser model=new WechatBuilder.Model.wx_ggkAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_ggkAwardUser DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_ggkAwardUser model=new WechatBuilder.Model.wx_ggkAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public WechatBuilder.Model.wx_ggkAwardUser getZJinfoByOpenid(int actId, string openid)
        {
