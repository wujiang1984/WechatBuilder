...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_payment_wxpay
	{
		...
		public WechatBuilder.Model.wx_payment_wxpay GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_payment_wxpay model=new WechatBuilder.Model.wx_payment_wxpay();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_payment_wxpay DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_payment_wxpay model=new WechatBuilder.Model.wx_payment_wxpay();
			if (row != null)
			{
