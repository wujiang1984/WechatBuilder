...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_payment_alipay
	{
		...
		public WechatBuilder.Model.wx_payment_alipay GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_payment_alipay model=new WechatBuilder.Model.wx_payment_alipay();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_payment_alipay DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_payment_alipay model=new WechatBuilder.Model.wx_payment_alipay();
			if (row != null)
			{
