...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_ucard_usercard
	{
		...
		public WechatBuilder.Model.wx_ucard_usercard GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_ucard_usercard model=new WechatBuilder.Model.wx_ucard_usercard();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_ucard_usercard DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_ucard_usercard model=new WechatBuilder.Model.wx_ucard_usercard();
			if (row != null)
			{
