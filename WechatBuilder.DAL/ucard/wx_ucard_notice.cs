...
namespace WechatBuilder.DAL
{
	...
	public partial class wx_ucard_notice
	{
		...
		public WechatBuilder.Model.wx_ucard_notice GetModel(int id)
		{
			...
			WechatBuilder.Model.wx_ucard_notice model=new WechatBuilder.Model.wx_ucard_notice();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_ucard_notice DataRowToModel(DataRow row)
		{
			WechatBuilder.Model.wx_ucard_notice model=new WechatBuilder.Model.wx_ucard_notice();
			if (row != null)
			{
