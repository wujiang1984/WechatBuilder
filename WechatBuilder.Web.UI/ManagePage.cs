...
namespace WechatBuilder.Web.UI
{
    public class ManagePage : System.Web.UI.Page
    {
        ...
        public bool IsAdminLogin()
        {
            ...
            {
                //检查Cookies
                string adminname = Utils.GetCookie("AdminName", "WechatBuilder");
                string adminpwd = Utils.GetCookie("AdminPwd", "WechatBuilder");
        ...
        public bool IsWeiXinCode()
        {
            ...
            {
                //检查Cookies
                string uweixinId = Utils.GetCookie("nowweixinId", "WechatBuilder");
                if (uweixinId != "")
                {
