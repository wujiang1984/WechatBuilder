<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_add.aspx.cs" Inherits="WechatBuilder.Web.shopmgr.setting.payment_add" ValidateRequest="false" %>
        ...
        <div class="tab-content">
            ...
            <%}
             ...
             <dl>
                <dt>财付通商户号</dt>
                <dd>
                    <asp:TextBox ID="txtpartnerId" runat="server" CssClass="input normal" datatype="*" sucmsg=" " nullmsg="*商户号(PartnerID)"></asp:TextBox>
                    <span class="Validform_checktip">*商户号(PartnerID)</span>
                </dd>
            </dl>
             ...
             <dl>
                <dt>财付通密钥</dt>
                <dd>
                    <asp:TextBox ID="txtpartnerKey" runat="server" CssClass="input normal" datatype="*" sucmsg=" " nullmsg="*财付通商家服务密钥(partnerKey)"></asp:TextBox>
                    <span class="Validform_checktip">*财付通商家服务密钥(partnerKey)</span>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*微信秘钥(paySignKey)</span>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">财付通安全证书(.pfx格式)，退款时需要，非必填项</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>财付通登录密码</dt>
                <dd>
                   <asp:TextBox ID="txtPartnerPwd" runat="server" CssClass="input normal" TextMode="Password" datatype="*0-100" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">财付通登录密码，退款时需要，非必填项</span>
                </dd>
            </dl>
