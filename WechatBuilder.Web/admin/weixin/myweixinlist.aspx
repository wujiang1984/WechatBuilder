<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myweixinlist.aspx.cs" Inherits="WechatBuilder.Web.admin.weixin.myweixinlist" %>
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <a href="editorWeiXin.aspx?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>" >修改</a>
                        <asp:LinkButton ID="btn_del" runat="server" OnClientClick="return ExeiskPostBack('btn_del','删除记录后不可恢复，您确定吗？');" CommandName="delete" CommandArgument='<%#Eval("id")%>'>删除</asp:LinkButton>
                    </td>
                    <td align="center">
