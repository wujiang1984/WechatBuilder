<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_article_list.aspx.cs" Inherits="WechatBuilder.Web.admin.article.wx_article_list" %>
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#new WechatBuilder.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
                    <td>
                        <%# Eval("link_url") %>
                    </td>
