<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_print.aspx.cs" Inherits="WechatBuilder.Web.admin.dialog.dialog_print" %>
...
<tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    ...
    <tr>
      <td valign="top">支付方式：<%=new WechatBuilder.BLL.payment().GetTitle(model.payment_id) %></td>
      <td>送货地址：<%=model.area%> <%=model.address%><br /></td>
    </tr>
    <tr>
      <td>配送方式：<%=new WechatBuilder.BLL.express().GetTitle(model.express_id)%></td>
