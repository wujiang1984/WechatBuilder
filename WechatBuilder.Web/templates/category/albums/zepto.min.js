...
function getCmdyCount() {
   // alert("统计购物车数量2");
    ...
    0 != a.length && utils.ajaxReq({
        url: window.basePath + "/shop/shopmgr.ashx?myact=pcount" + "&wid=" + $("#hidwid").val() + "&openid=" + $("#openid").val(),
        dataType: "json",
        data: {
            t: +new Date
        }
    ...
    address.init = function () {
        ...
        $("#province").on("change", function () {
            ...
            utils.ajaxReq(e, function (f) {
                ...
                ("1" == b || "2" == b || "9" == b || "22" == b) && (c = $("#scity").attr("data-url"), d.ctid = f.data[0].id, a.cityNode.val(d.ctid), e.url = c, e.data = d, utils.ajaxReq(e, function (b) {
...
function getCmdyCount() {
    //alert("统计购物车数量1" + window.basePath + "/shop/shopmgr.ashx?myact=pcount" + "&wid=" + $("#hidwid").val() + "&openid=" + $("#openid").val());
    var a = $(".icon_number_bubble");
    0 != a.length && utils.ajaxReq({
        url: window.basePath + "/shop/shopmgr.ashx?myact=pcount" + "&wid=" + $("#hidwid").val() + "&openid=" + $("#openid").val(),
        dataType: "json",
...
utils.namespace("mobile.o2ocn.addrList"), utils.namespace("mobile.o2ocn.addrchoose"), function () {
    ...
    address.init = function () {
        ...
        this.isUpdate = parseInt($("#isUpdate").val(), 10), this.provId = parseInt($("#provId").val(), 10), this.oprTip = parseInt($("#oprTip").val(), 10), this.provinceNode = $("#province"), this.cityNode = $("#city"), this.regionNode = $("#regionId"), this.allProvince =
            [{ "pname": "北京市", "provinceId": 1 },
{ "pname": "天津市", "provinceId": 2 },
{ "pname": "河北省", "provinceId": 3 },
{ "pname": "山西省", "provinceId": 4 },
{ "pname": "内蒙古自治区", "provinceId": 5 },
{ "pname": "辽宁省", "provinceId": 6 },
{ "pname": "吉林省", "provinceId": 7 },
{ "pname": "黑龙江省", "provinceId": 8 },
{ "pname": "上海市", "provinceId": 9 },
{ "pname": "江苏省", "provinceId": 10 },
{ "pname": "浙江省", "provinceId": 11 },
{ "pname": "安徽省", "provinceId": 12 },
{ "pname": "福建省", "provinceId": 13 },
{ "pname": "江西省", "provinceId": 14 },
{ "pname": "山东省", "provinceId": 15 },
{ "pname": "河南省", "provinceId": 16 },
{ "pname": "湖北省", "provinceId": 17 },
{ "pname": "湖南省", "provinceId": 18 },
{ "pname": "广东省", "provinceId": 19 },
{ "pname": "广西壮族自治区", "provinceId": 20 },
{ "pname": "海南省", "provinceId": 21 },
{ "pname": "重庆市", "provinceId": 22 },
{ "pname": "四川省", "provinceId": 23 },
{ "pname": "贵州省", "provinceId": 24 },
{ "pname": "云南省", "provinceId": 25 },
{ "pname": "西藏自治区", "provinceId": 26 },
{ "pname": "陕西省", "provinceId": 27 },
{ "pname": "甘肃省", "provinceId": 28 },
{ "pname": "青海省", "provinceId": 29 },
{ "pname": "宁夏回族自治区", "provinceId": 30 },
{ "pname": "新疆维吾尔自治区", "provinceId": 31 },
{ "pname": "台湾省", "provinceId": 32 },
{ "pname": "香港特别行政区", "provinceId": 33 },
{ "pname": "澳门特别行政区", "provinceId": 34 },
{ "pname": "海外", "provinceId": 35 },
{ "pname": "其他", "provinceId": 36 }];
        var a = this;
        $.each(a.allProvince, function (b, c) {
            c.provinceId == a.provId ? a.provinceNode.append("<option value='" + c.provinceId + "' selected='selected'>" + c.pname + "</option>") : a.provinceNode.append("<option value='" + c.provinceId + "'>" + c.pname + "</option>")
        ...
        $("#province").on("change", function () {
          ...
          //  alert("省份改变2=" + a.cityNode);
            utils.ajaxReq(e, function (f) {
                ...
                ("1" == b || "2" == b || "9" == b || "22" == b || "35" == b) && (c = $("#scity").attr("data-url"),
                d.ctid = f.data[0].id,
    ...
    a.init = function () {
       ...
       // alert("window.basePath=" + window.basePath + "ic=" + $("#ic").val() + " attr=" + this.buyProperty + " mid=" + window.availSku[this.buyProperty].pid + " bc=" + this.buyNum + " openid=" + $("#openid").val() + " totprice=" + $("#totprice").val());//我添加的
        utils.ajaxReq({
