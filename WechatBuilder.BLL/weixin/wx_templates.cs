...
namespace WechatBuilder.BLL
{
	...
	{
		private readonly WechatBuilder.DAL.wx_templates dal=new WechatBuilder.DAL.wx_templates();
		public wx_templates()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_templates> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_templates> DataTableToList(DataTable dt)
		{
			List<WechatBuilder.Model.wx_templates> modelList = new List<WechatBuilder.Model.wx_templates>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WechatBuilder.Model.wx_templates model;
