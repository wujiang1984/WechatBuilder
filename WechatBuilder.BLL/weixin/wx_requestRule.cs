...
namespace WechatBuilder.BLL
{
    ...
    {
        private readonly WechatBuilder.DAL.wx_requestRule dal = new WechatBuilder.DAL.wx_requestRule();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(WechatBuilder.Model.wx_requestRule model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WechatBuilder.Model.wx_requestRule model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public WechatBuilder.Model.wx_requestRule GetModel(int id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WechatBuilder.Model.wx_requestRule> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WechatBuilder.Model.wx_requestRule> DataTableToList(DataTable dt)
        {
            List<WechatBuilder.Model.wx_requestRule> modelList = new List<WechatBuilder.Model.wx_requestRule>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                WechatBuilder.Model.wx_requestRule model;
