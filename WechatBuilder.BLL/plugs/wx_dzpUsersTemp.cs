...
namespace WechatBuilder.BLL
{
	...
	{
		private readonly WechatBuilder.DAL.wx_dzpUsersTemp dal=new WechatBuilder.DAL.wx_dzpUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public WechatBuilder.Model.wx_dzpUsersTemp GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_dzpUsersTemp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_dzpUsersTemp> DataTableToList(DataTable dt)
		{
			List<WechatBuilder.Model.wx_dzpUsersTemp> modelList = new List<WechatBuilder.Model.wx_dzpUsersTemp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WechatBuilder.Model.wx_dzpUsersTemp model;
