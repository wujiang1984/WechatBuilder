...
namespace WechatBuilder.BLL
{
	...
	{
		private readonly WechatBuilder.DAL.wx_diancai_dingdan_manage dal=new WechatBuilder.DAL.wx_diancai_dingdan_manage();
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_diancai_dingdan_manage> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_diancai_dingdan_manage> DataTableToList(DataTable dt)
		{
			List<WechatBuilder.Model.wx_diancai_dingdan_manage> modelList = new List<WechatBuilder.Model.wx_diancai_dingdan_manage>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WechatBuilder.Model.wx_diancai_dingdan_manage model;
