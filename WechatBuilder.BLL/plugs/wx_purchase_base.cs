...
namespace WechatBuilder.BLL
{
	...
	{
		private readonly WechatBuilder.DAL.wx_purchase_base dal=new WechatBuilder.DAL.wx_purchase_base();
        ...
        /// 获得数据列表
        /// </summary>
        public List<WechatBuilder.Model.wx_purchase_base> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WechatBuilder.Model.wx_purchase_base> DataTableToList(DataTable dt)
        {
            List<WechatBuilder.Model.wx_purchase_base> modelList = new List<WechatBuilder.Model.wx_purchase_base>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                WechatBuilder.Model.wx_purchase_base model;
