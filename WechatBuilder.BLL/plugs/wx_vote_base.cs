...
namespace WechatBuilder.BLL
{
	...
	{
		private readonly WechatBuilder.DAL.wx_vote_base dal=new WechatBuilder.DAL.wx_vote_base();
		public wx_vote_base()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_vote_base> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_vote_base> DataTableToList(DataTable dt)
		{
			List<WechatBuilder.Model.wx_vote_base> modelList = new List<WechatBuilder.Model.wx_vote_base>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WechatBuilder.Model.wx_vote_base model;
