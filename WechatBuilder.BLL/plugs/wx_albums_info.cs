...
namespace WechatBuilder.BLL
{
	...
	{
		private readonly WechatBuilder.DAL.wx_albums_info dal=new WechatBuilder.DAL.wx_albums_info();
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_albums_info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WechatBuilder.Model.wx_albums_info> DataTableToList(DataTable dt)
		{
			List<WechatBuilder.Model.wx_albums_info> modelList = new List<WechatBuilder.Model.wx_albums_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WechatBuilder.Model.wx_albums_info model;
